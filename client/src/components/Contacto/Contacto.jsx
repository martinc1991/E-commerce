					...
					<div style={{ width: '24rem', marginTop:'50px', marginLeft:'50px'}}>
						<Container>
							<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdjOiVz4aYIimh9zrK7Nru5SzjPTr9p-VSZADnKr7HuJJoXZg/viewform?embedded=true"
	 						width="640" height="850" frameborder="20px" marginheight="20px" marginwidth="4px">Cargando…</iframe>
				</Container>
					</div>
			    ...
			    <Card.Text>
						...
						<ul className={`list-unstyled mb-0`}>
								...
								<li><i className={`fas fa-envelope mt-4 fa-2x`}></i>
										<p>email: <span className={`font-italic`}> ecommercehenrylabs@gmail.com</span></p>
								</li>
						</ul>
			    </Card.Text>
